...
public class ComponentsTranslation {
  ...
  public static HashMap<String, String> map() {
    ...
    map.put("PROPDESC-BestMoveXPropertyDescriptions", MESSAGES.BestMoveXPropertyDescriptions());
    map.put("PROPDESC-BestMoveYPropertyDescriptions", MESSAGES.BestMoveYPropertyDescriptions());
    map.put("METHODDESC-MiniMaxMethodDescriptions", MESSAGES.MiniMaxMethodDescriptions());
    map.put("METHODDESC-getRandomMethodDescriptions", MESSAGES.getRandomMethodDescriptions());
